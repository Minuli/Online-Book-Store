...
public class signUp extends javax.swing.JFrame {
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(txt2)
                            .addComponent(pwd)
                            .addComponent(repwd, javax.swing.GroupLayout.DEFAULT_SIZE, 198, Short.MAX_VALUE)))
                    .addGroup(layout.createSequentialGroup()
                        .addGap(147, 147, 147)
                        .addComponent(btnSU)))
    ...
    private void btnSUActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSUActionPerformed
        ...
        try {
            ...
            char[] repassword=pwd.getPassword();
            ...
            if(pwd.equals(repwd))
            {
                int count=st.executeUpdate("insert into Customer values('"+uid+"','"+uname+"','"+pwd+"')");
          
                 if(count>0)
                {
                     JOptionPane.showMessageDialog(null,"Record Submitted","Submition",JOptionPane.INFORMATION_MESSAGE);
                 }
            }
            else
            {
                JOptionPane.showMessageDialog(null,"Error-Password","SignuP",JOptionPane.WARNING_MESSAGE);
            }
            ...
            System.out.println(e.getMessage());
            System.out.println("Please re-enter password corectly. ");
        } 
